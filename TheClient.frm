...
SUB __UI_LoadForm
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_Form, "TheClient", 300, 290, 0, 0, 0)
    SetCaption __UI_NewID, "The client"
    Control(__UI_NewID).Font = SetFont("arial.ttf", 12)

    __UI_NewID = __UI_NewControl(__UI_Type_Label, "ConnectionStatusLB", 108, 21, 10, 14, 0)
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_PictureBox, "PictureBox1", 277, 236, 10, 40, 0)
...
SUB __UI_AssignIDs
    TheClient = __UI_GetID("TheClient")
